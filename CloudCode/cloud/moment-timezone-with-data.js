...
(function (root, factory) {
	...
	if (typeof define === 'function' && define.amd) {
		...
		// modified for parse.com cloud as per:
		// http://buildwebthings.com/use-moment-moment-timezone-parse-cloud-code/
		module.exports = factory(require('cloud/moment-with-locales')); // Node
	} else {
